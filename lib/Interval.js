...
Interval.prototype.invert = function invert ( interval ) {
  if ( interval instanceof Interval ) {
    return new Interval([ [ interval.min(), interval.max() ] ]).subtract(this);
  }
  else if ( interval instanceof Array ) {
    return new Interval([ interval ]).subtract(this);
  }
  else return new Interval([ [ this.min(), this.max() ] ]).subtract(this);
}
